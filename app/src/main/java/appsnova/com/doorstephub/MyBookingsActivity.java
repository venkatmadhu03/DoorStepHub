...
public class MyBookingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myBookingsAdapter = new MyBookingsAdapter(myBookingsModels);
    ...
    public void mybookingsdetails()
    {
        MyBookingsModel bookingsModel = new MyBookingsModel("#834536",
                "Harbhajan Singh","Microwave Open Service and Repairs","Grill Microwave","10/6/2018 6:17:14PM");
        myBookingsModels.add(bookingsModel);

        bookingsModel = new MyBookingsModel("#834544",
                "Bharath","Refrigerator Service and Repairs","Single Door Fridge repair","15/6/2018 7:17:14PM");
        myBookingsModels.add(bookingsModel);

        bookingsModel = new MyBookingsModel("#834545",
                "Swamy","Painting Service","Commercial","20/6/2018 8:17:14PM");
        myBookingsModels.add(bookingsModel);

        bookingsModel = new MyBookingsModel("#834548",
                "Singh","Computer Service and Repairs","Desktop","01/8/2018 9:17:14PM");
        myBookingsModels.add(bookingsModel);
