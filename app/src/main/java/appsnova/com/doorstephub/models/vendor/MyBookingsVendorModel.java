...
public class MyBookingsVendorModel {

    String orderid,username,servicerequired,subservice,scheduleddate,status;

    public MyBookingsVendorModel(String orderid, String username, String servicerequired, String subservice, String scheduleddate, String status) {
